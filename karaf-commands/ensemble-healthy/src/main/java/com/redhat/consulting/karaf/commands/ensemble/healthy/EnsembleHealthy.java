...
@org.apache.felix.scr.annotations.Properties({
    @Property(name = "osgi.command.scope", value = EnsembleHealthy.SCOPE_VALUE),
    @Property(name = "osgi.command.function", value = EnsembleHealthy.FUNCTION_VALUE)
    })
public class EnsembleHealthy extends AbstractCommandComponent {

    public static final String SCOPE_VALUE = "fabric";
    public static final String FUNCTION_VALUE = "ensemble-healthy";
    public static final String DESCRIPTION = "Checks the ensemble is as-is expected";
    ...
    public Action createNewAction() {
        assertValid();
        return new EnsembleHealthyAction(clusterService.get());
    }
