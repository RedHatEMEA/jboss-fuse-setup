...
@org.apache.felix.scr.annotations.Properties({
    @Property(name = "osgi.command.scope", value = ContainerStatus.SCOPE_VALUE),
    @Property(name = "osgi.command.function", value = ContainerStatus.FUNCTION_VALUE)
    })
public class ContainerStatus extends AbstractCommandComponent {

    public static final String SCOPE_VALUE = "fabric";
    public static final String FUNCTION_VALUE = "container-status";
    public static final String DESCRIPTION = "Checks the status of a container matches what is expected";
    ...
    public Action createNewAction() {
        assertValid();
        return new ContainerStatusAction(fabricService.get());
    }
